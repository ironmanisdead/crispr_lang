...
DLL_PUBLIC char Crispr_symName(const char* restrict str, Crispr_Size off, Crispr_Errno* restrict err);
DLL_PUBLIC char Crispr_symVm(const char* restrict str, Crispr_Size off, Crispr_Errno* restrict err);
